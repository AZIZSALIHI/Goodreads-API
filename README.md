This was a small task I had been requested to do. The task was to build an output interface while working with a 3rd-party API (Goodreads) using vanilla HTML/CSS/JS.
